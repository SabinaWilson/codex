...
Below are a few bite-size examples you can copy-paste. Replace the text in quotes with your own task. See the [prompting guide](https://github.com/Haleclipse/codex/blob/main/codex-cli/examples/prompting_guide.md) for more tips and usage patterns.
...
git clone https://github.com/Haleclipse/codex.git
cd codex/codex-cli
